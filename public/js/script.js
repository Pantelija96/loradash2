...
function postaviCenuSenzora(id) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            document.getElementById("brojAktivnih" + id).setAttribute("max", parseInt(data.response.komadaNaLageru));
            document.getElementById("brojNeaktivnih" + id).setAttribute("max", parseInt(data.response.komadaNaLageru));
            document.getElementById("nabavnaCena" + id).value = parseInt(data.response.nabavnaCena);
            document.getElementById("cenaTehnickePodrske" + id).value = parseInt(data.response.tehnickaPodrska);
            izracunajCenu();
        },
        error: function (xhr, status, error) {
            alert('Desila se greska, proveriti console.');
